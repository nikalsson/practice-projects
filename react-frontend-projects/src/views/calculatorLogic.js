...
class Calculator extends React.PureComponent {
  ...
  render(){
    return (
      <CalculatorBody state ={ this.state }  receiveNumberPress ={ this.receiveNumberPress }  receiveOperationPress ={ this.receiveOperationPress }  solveEquation ={ this.solveEquation }  clearDisplay ={ this.clearDisplay }/>
    );
  }
}
